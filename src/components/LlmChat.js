...
const LlmChatContainer = styled.div`
  ...
  height: calc(100vh - 80px); /* 헤더와 푸터를 고려한 높이 */
  background-color: #202123; /* ChatGPT와 유사한 배경색 */
  color: #e0e0e0;
...
const ChatMessages = styled.div`
  ...
  scrollbar-color: #555 #202123; /* Firefox */
  &::-webkit-scrollbar {
    width: 8px;
  }
...
const Message = styled.div`
  ...
  padding: 12px 18px;
  border-radius: 18px;
  background-color: ${props => (props.isUser ? '#3A8DFF' : '#444654')}; /* 사용자/AI 색상 구분 */
  color: #fff;
